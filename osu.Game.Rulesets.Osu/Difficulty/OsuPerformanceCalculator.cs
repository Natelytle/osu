    ...
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        private double computeAimValue(ScoreInfo score, OsuDifficultyAttributes attributes)
        {
            ...
            if (effectiveMissCount > 0)
                aimValue *= calculateAimMissPenalty(effectiveMissCount, attributes.AimMissCountPolynomial);
        ...
        private double calculateAimMissPenalty(double missCount, ExpPolynomial expPolynomial) => Math.Pow(1 - (expPolynomial.GetSkillMultiplier(missCount) ?? 1), 1.5);
