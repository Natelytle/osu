...
{
    /// <summary>
    /// Represents a group of <see cref="OsuDifficultyHitObject"/>s with no rhythm variation.
    /// </summary>
    public class EvenHitObjects : EvenRhythm<OsuDifficultyHitObject>, IHasInterval
    {
        public OsuDifficultyHitObject FirstHitObject => Children.First();
        ...
        public EvenHitObjects(EvenHitObjects? previous, List<OsuDifficultyHitObject> data, ref int i)
            : base(data, ref i, 3)
        {
            Previous = previous;
        ...
        public static List<EvenHitObjects> GroupHitObjects(List<OsuDifficultyHitObject> data)
        {
