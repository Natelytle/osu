...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing.Rhythm
{
    ...
    public class EvenPatterns : EvenRhythm<EvenHitObjects>
    {
        ...
        public OsuDifficultyHitObject FirstHitObject => Children[0].FirstHitObject;

        public IEnumerable<OsuDifficultyHitObject> AllHitObjects => Children.SelectMany(child => child.Children);
            ...
            : base(data, ref i, 3)
        {
            ...
            foreach (OsuDifficultyHitObject hitObject in AllHitObjects)
            {
