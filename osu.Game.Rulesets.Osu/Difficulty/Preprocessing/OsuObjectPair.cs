...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    ...
    internal struct OsuObjectPair
    {
        ...
        public OsuObjectPair(OsuHitObject first, OsuHitObject second, double gameplayRate)
        {
        ...
        public static OsuObjectPair? Nullable(OsuHitObject? first, OsuHitObject? second, double gameplayRate)
        {
