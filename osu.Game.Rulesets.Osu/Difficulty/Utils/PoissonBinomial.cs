...
namespace osu.Game.Rulesets.Osu.Difficulty.Utils
{
    ...
    public class PoissonBinomial
    {
        ...
        /// <summary>
        /// Creates a Poisson binomial distribution based on N trials with the provided <paramref name="difficulties"/> and function to convert them to probabilities.
        /// </summary>
        /// <param name="difficulties">The difficulties in the map.</param>
        /// <param name="skill">The skill level to get the miss probabilities with.</param>
        /// <param name="hitProbabilityFunc">The function to get the hit probability.</param>
        public PoissonBinomial(IList<double> difficulties, double skill, Func<double, double, double> hitProbabilityFunc)
        {
            double variance = 0;
            double gamma = 0;
            ...
            {
                double p = 1 - hitProbabilityFunc(skill, d);
        ...
        /// <param name="skill">The skill level to get the miss probabilities with.</param>
        /// <param name="hitProbabilityFunc">The function to get the hit probability.</param>
        public PoissonBinomial(Bin[] bins, double skill, Func<double, double, double> hitProbabilityFunc)
        {
            double variance = 0;
            double gamma = 0;
            ...
            {
                double p = 1 - hitProbabilityFunc(skill, bin.Difficulty);
