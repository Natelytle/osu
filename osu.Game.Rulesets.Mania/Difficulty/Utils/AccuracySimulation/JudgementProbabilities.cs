...
namespace osu.Game.Rulesets.Mania.Difficulty.Utils.AccuracySimulation
{
    public readonly struct JudgementProbabilities
    {
        ...
        public double Gamma => (AccuracySimulator.MAX_JUDGEMENT_WEIGHT - Score) * (AccuracySimulator.MAX_JUDGEMENT_WEIGHT - Score) * (AccuracySimulator.MAX_JUDGEMENT_WEIGHT - Score) * pMax +
                               (300 - Score) * (300 - Score) * (300 - Score) * p300 +
                               (200 - Score) * (200 - Score) * (200 - Score) * p200 +
                               (100 - Score) * (100 - Score) * (100 - Score) * p100 +
                               (50 - Score) * (50 - Score) * (50 - Score) * p50 +
                               (0 - Score) * (0 - Score) * (0 - Score) * p0;
    }
}
