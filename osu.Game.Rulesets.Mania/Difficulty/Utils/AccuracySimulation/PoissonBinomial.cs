...
{
    public interface IPoissonBinomial
    {
        // ReSharper disable once InconsistentNaming
        double CDF(double count);
    }
    ...
    /// </para>
    /// </remarks>
    public class PoissonBinomial : IPoissonBinomial
    {
        /// <summary>
    ...
    public class IterativePoissonBinomial : IPoissonBinomial
    {
        private double debugCount, debugScore, mu, var, gamma;
        ...
        public void Add(double mean, double variance, double thirdMoment)
        {
            mu += mean;
            var += variance;
            gamma += thirdMoment;
        ...
        public void AddJudgementProbabilities(JudgementProbabilities judgementProbabilities, double count = 1)
        {
            debugCount += count;
            debugScore += count + 305;
            mu += judgementProbabilities.Score * count;
            var += judgementProbabilities.Variance * count;
            gamma += judgementProbabilities.Gamma * count;
        }
