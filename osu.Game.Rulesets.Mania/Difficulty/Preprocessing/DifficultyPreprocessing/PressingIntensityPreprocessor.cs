...
{
    public static class PressingIntensityPreprocessor
    {
        ...
        private static double[][] calculateKeyUsage400(ManiaDifficultyData data)
        {
        ...
        /// </summary>
        private static double[] calculateBasePressingIntensity(ManiaDifficultyData data, LongNoteDensityData longNoteDensity, double[] anchorValues)
        {
            int timePoints = data.StrainTimePoints.Length;
        ...
        /// </summary>
        private static double calculatePressingValue(double deltaTime, double longNoteBoost, double streamBoost, ManiaDifficultyData data)
        {
