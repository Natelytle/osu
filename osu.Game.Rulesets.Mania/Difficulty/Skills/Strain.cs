...
{
    public class Strain : ManiaProbSkill
    {
        ...
        private double strainDecayBase => 1;
        ...
        public Strain(Mod[] mods, int totalColumns, double overallDifficulty)
            : base(mods, overallDifficulty)
        {
