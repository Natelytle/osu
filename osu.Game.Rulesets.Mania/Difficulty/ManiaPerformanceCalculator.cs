...
namespace osu.Game.Rulesets.Mania.Difficulty
{
    public class ManiaPerformanceCalculator : PerformanceCalculator
    {
        ...
        protected override PerformanceAttributes CreatePerformanceAttributes(ScoreInfo score, DifficultyAttributes attributes)
        {
            ...
            double[] hitWindows = isLegacyScore ? getLegacyHitWindows(score.Mods, false, maniaAttributes.OverallDifficulty) : getLazerHitWindows(score.Mods, maniaAttributes.OverallDifficulty);
        ...
        private double accuracyMultiplier(ManiaDifficultyAttributes attributes)
        {
            ...
            return estimatedUnstableRate is not null ? lowAccFade * accuracyScaling(estimatedUnstableRate.Value, attributes.StarRating) : 0;
        }
        ...
        private LogProbability compProbHitLegacyHold(double window, double headDeviation, double tailDeviation)
        {
            ...
            double z = DiffUtils.NormalCdf(0, 1, beta) - 0.5;
            double expectedValue = headDeviation * (DiffUtils.NormalPdf(0, 1, 0) - DiffUtils.NormalPdf(0, 1, beta)) / z;
