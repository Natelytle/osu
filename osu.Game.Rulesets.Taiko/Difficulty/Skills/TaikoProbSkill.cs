...
{
    public abstract class TaikoProbSkill : Skill
    {
        protected TaikoProbSkill(Mod[] mods)
            : base(mods)
        {
        }
        ...
        /// <summary>
        /// Finds the probability of hitting a note, given skill level and the difficulty of the note.
        /// </summary>
        /// <param name="skill">The skill level to find the probability of hitting each note with.</param>
        /// <param name="difficulty">The difficulty of the note.</param>
        /// <returns></returns>
