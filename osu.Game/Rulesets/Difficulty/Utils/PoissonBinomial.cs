...
namespace osu.Game.Rulesets.Difficulty.Utils
{
    ...
    public class PoissonBinomial
    {
        ...
        public PoissonBinomial(List<Bin> bins, double skill, Func<double, double, double> hitProbability)
        {
            ...
            foreach (Bin bin in bins)
            {
                ...
                mu += p * bin.NoteCount;
                variance += p * (1 - p) * bin.NoteCount;
                gamma += p * (1 - p) * (1 - 2 * p) * bin.NoteCount;
            }
    ...
    public class IterativePoissonBinomial
    {
        ...
        public void AddBinnedJudgementProbabilities(IJudgementProbabilities judgementProbabilities, int count)
        {
